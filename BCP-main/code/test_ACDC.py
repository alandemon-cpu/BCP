...
from networks.net_factory import net_factory, net_factory, highnet,lownet
...
def Inference(FLAGS):
    ...
    net = highnet( in_chns=1, class_num=FLAGS.num_classes)
    ...
    save_model_path = os.path.join(snapshot_path, 'highnet_best_model.pth')
